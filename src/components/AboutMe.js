      ...
      <Row className="py-4">
        <Col className="col-xl-8 Light ">
          ...
          <div className="d-flex flex-column">
            <p className="fs-5 ">Hello! my name is Jacob Nelson-Stone. I am 22 years old, I love music, my wife and son, and I love coding and programming to help solve problems and make people's lives easier!<br /><br /> I've always been interested in tech and computing, and I decided to take the plunge into Web Development at the beginning of 2023.I love programming and solving problems, so being able to do that professionally is incredible. <br /> <br />Enjoy looking through my portfolio and I look forward to hearing from you! </p>
          </div>
        </Col>
